...
class UBTEDU_ROBOTSERVO_T(_object):
    ...
    if _newclass:
        SERVO1_ANGLE = _swig_property(_RobotApi.UBTEDU_ROBOTSERVO_T_SERVO1_ANGLE_get, _RobotApi.UBTEDU_ROBOTSERVO_T_SERVO1_ANGLE_set)
    ...
    if _newclass:
        SERVO2_ANGLE = _swig_property(_RobotApi.UBTEDU_ROBOTSERVO_T_SERVO2_ANGLE_get, _RobotApi.UBTEDU_ROBOTSERVO_T_SERVO2_ANGLE_set)
    ...
    if _newclass:
        SERVO3_ANGLE = _swig_property(_RobotApi.UBTEDU_ROBOTSERVO_T_SERVO3_ANGLE_get, _RobotApi.UBTEDU_ROBOTSERVO_T_SERVO3_ANGLE_set)
    ...
    if _newclass:
        SERVO4_ANGLE = _swig_property(_RobotApi.UBTEDU_ROBOTSERVO_T_SERVO4_ANGLE_get, _RobotApi.UBTEDU_ROBOTSERVO_T_SERVO4_ANGLE_set)
    ...
    if _newclass:
        SERVO5_ANGLE = _swig_property(_RobotApi.UBTEDU_ROBOTSERVO_T_SERVO5_ANGLE_get, _RobotApi.UBTEDU_ROBOTSERVO_T_SERVO5_ANGLE_set)
    ...
    if _newclass:
        SERVO6_ANGLE = _swig_property(_RobotApi.UBTEDU_ROBOTSERVO_T_SERVO6_ANGLE_get, _RobotApi.UBTEDU_ROBOTSERVO_T_SERVO6_ANGLE_set)
    ...
    if _newclass:
        SERVO7_ANGLE = _swig_property(_RobotApi.UBTEDU_ROBOTSERVO_T_SERVO7_ANGLE_get, _RobotApi.UBTEDU_ROBOTSERVO_T_SERVO7_ANGLE_set)
    ...
    if _newclass:
        SERVO8_ANGLE = _swig_property(_RobotApi.UBTEDU_ROBOTSERVO_T_SERVO8_ANGLE_get, _RobotApi.UBTEDU_ROBOTSERVO_T_SERVO8_ANGLE_set)
    ...
    if _newclass:
        SERVO9_ANGLE = _swig_property(_RobotApi.UBTEDU_ROBOTSERVO_T_SERVO9_ANGLE_get, _RobotApi.UBTEDU_ROBOTSERVO_T_SERVO9_ANGLE_set)
    ...
    if _newclass:
        SERVO10_ANGLE = _swig_property(_RobotApi.UBTEDU_ROBOTSERVO_T_SERVO10_ANGLE_get, _RobotApi.UBTEDU_ROBOTSERVO_T_SERVO10_ANGLE_set)
    ...
    if _newclass:
        SERVO11_ANGLE = _swig_property(_RobotApi.UBTEDU_ROBOTSERVO_T_SERVO11_ANGLE_get, _RobotApi.UBTEDU_ROBOTSERVO_T_SERVO11_ANGLE_set)
    ...
    if _newclass:
        SERVO12_ANGLE = _swig_property(_RobotApi.UBTEDU_ROBOTSERVO_T_SERVO12_ANGLE_get, _RobotApi.UBTEDU_ROBOTSERVO_T_SERVO12_ANGLE_set)
    ...
    if _newclass:
        SERVO13_ANGLE = _swig_property(_RobotApi.UBTEDU_ROBOTSERVO_T_SERVO13_ANGLE_get, _RobotApi.UBTEDU_ROBOTSERVO_T_SERVO13_ANGLE_set)
    ...
    if _newclass:
        SERVO14_ANGLE = _swig_property(_RobotApi.UBTEDU_ROBOTSERVO_T_SERVO14_ANGLE_get, _RobotApi.UBTEDU_ROBOTSERVO_T_SERVO14_ANGLE_set)
    ...
    if _newclass:
        SERVO15_ANGLE = _swig_property(_RobotApi.UBTEDU_ROBOTSERVO_T_SERVO15_ANGLE_get, _RobotApi.UBTEDU_ROBOTSERVO_T_SERVO15_ANGLE_set)
    ...
    if _newclass:
        SERVO16_ANGLE = _swig_property(_RobotApi.UBTEDU_ROBOTSERVO_T_SERVO16_ANGLE_get, _RobotApi.UBTEDU_ROBOTSERVO_T_SERVO16_ANGLE_set)
    ...
    if _newclass:
        SERVO17_ANGLE = _swig_property(_RobotApi.UBTEDU_ROBOTSERVO_T_SERVO17_ANGLE_get, _RobotApi.UBTEDU_ROBOTSERVO_T_SERVO17_ANGLE_set)
...
class UBTEDU_ROBOTGYRO_SENSOR_T(_object):
    ...
    if _newclass:
        dGyroxValue = _swig_property(_RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dGyroxValue_get, _RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dGyroxValue_set)
    ...
    if _newclass:
        dGyroyValue = _swig_property(_RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dGyroyValue_get, _RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dGyroyValue_set)
    ...
    if _newclass:
        dGyrozValue = _swig_property(_RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dGyrozValue_get, _RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dGyrozValue_set)
    ...
    if _newclass:
        dAccexValue = _swig_property(_RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dAccexValue_get, _RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dAccexValue_set)
    ...
    if _newclass:
        dAcceyValue = _swig_property(_RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dAcceyValue_get, _RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dAcceyValue_set)
    ...
    if _newclass:
        dAccezValue = _swig_property(_RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dAccezValue_get, _RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dAccezValue_set)
    ...
    if _newclass:
        dCompassxValue = _swig_property(_RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dCompassxValue_get, _RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dCompassxValue_set)
    ...
    if _newclass:
        dCompassyValue = _swig_property(_RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dCompassyValue_get, _RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dCompassyValue_set)
    ...
    if _newclass:
        dCompasszValue = _swig_property(_RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dCompasszValue_get, _RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dCompasszValue_set)
    ...
    if _newclass:
        dEulerxValue = _swig_property(_RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dEulerxValue_get, _RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dEulerxValue_set)
    ...
    if _newclass:
        dEuleryValue = _swig_property(_RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dEuleryValue_get, _RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dEuleryValue_set)
    ...
    if _newclass:
        dEulerzValue = _swig_property(_RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dEulerzValue_get, _RobotApi.UBTEDU_ROBOTGYRO_SENSOR_T_dEulerzValue_set)
...
class UBTEDU_ROBOTENV_SENSOR_T(_object):
    ...
    if _newclass:
        iTempValue = _swig_property(_RobotApi.UBTEDU_ROBOTENV_SENSOR_T_iTempValue_get, _RobotApi.UBTEDU_ROBOTENV_SENSOR_T_iTempValue_set)
    ...
    if _newclass:
        iHumiValue = _swig_property(_RobotApi.UBTEDU_ROBOTENV_SENSOR_T_iHumiValue_get, _RobotApi.UBTEDU_ROBOTENV_SENSOR_T_iHumiValue_set)
    ...
    if _newclass:
        iPresValue = _swig_property(_RobotApi.UBTEDU_ROBOTENV_SENSOR_T_iPresValue_get, _RobotApi.UBTEDU_ROBOTENV_SENSOR_T_iPresValue_set)
...
def ubtGetRobotServo(servoAngle):
    return _RobotApi.ubtGetRobotServo(servoAngle)
ubtGetRobotServo = _RobotApi.ubtGetRobotServo

def ubtSetRobotServo(servoAngle, iTime):
    return _RobotApi.ubtSetRobotServo(servoAngle, iTime)
...
def ubtEventDetect(pcEventType, pcValue, iTimeout):
    return _RobotApi.ubtEventDetect(pcEventType, pcValue, iTimeout)
ubtEventDetect = _RobotApi.ubtEventDetect

def ubtFaceCompare(iTimeout, pcValue):
    return _RobotApi.ubtFaceCompare(iTimeout, pcValue)
...
def ubtRobotDiscovery(pcAccount, iMaxTimes, pstRobotInfo):
    return _RobotApi.ubtRobotDiscovery(pcAccount, iMaxTimes, pstRobotInfo)
...
def ubtOpenCameraStream(pcMode, iPosX, iPosY, iViewW, iViewH):
    return _RobotApi.ubtOpenCameraStream(pcMode, iPosX, iPosY, iViewW, iViewH)
...
def ubtCaptureDLPhoto(pcDataPath):
    return _RobotApi.ubtCaptureDLPhoto(pcDataPath)
ubtCaptureDLPhoto = _RobotApi.ubtCaptureDLPhoto

def ubtAddDLSample(iType, pcTagName, pcData):
    return _RobotApi.ubtAddDLSample(iType, pcTagName, pcData)
ubtAddDLSample = _RobotApi.ubtAddDLSample

def ubtFaceAgeGender(iTimeout, pcGender, pcAge):
    return _RobotApi.ubtFaceAgeGender(iTimeout, pcGender, pcAge)
ubtFaceAgeGender = _RobotApi.ubtFaceAgeGender

def ubtDeleteDLSample(iType, pcTagName):
    return _RobotApi.ubtDeleteDLSample(iType, pcTagName)
ubtDeleteDLSample = _RobotApi.ubtDeleteDLSample

def ubtResetDLSample(iType):
    return _RobotApi.ubtResetDLSample(iType)
